...
# 4e. DNS fix: binary musl me-parse /etc/resolv.conf sendiri (bukan
#     resolver Android). Kalau file tidak ada / kosong / hanya
#     localhost, semua koneksi API gagal ("Cannot connect to API").
